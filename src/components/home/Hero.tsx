  ...
  return (
    <>
      ...
      <div className=" lg:px-20 max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center justify-between gap-12  md:p-0 ">
        <div className=" text-center md:w-[550px] pt-28 lg:pt-10 lg:text-left order-2  lg:pb-16 lg:order-none">
        ...
        <div className="order-1 lg:order-none lg:pt-10 lg:pb-0">
          <Image
            ...
            className="w-[300px] sm:w-[250px] md:w-[350px] lg:w-[650px]"
            width={1000}
            height={1000}
            alt="Hero Image"
          />
      ...
      <div className="absolute left-0 top-[650px] md:top-[570px] lg:top-[570px]">
