...
export default function Features() {
  return (
    <>
      ...
      <div className="dark:bg-black">
        <div className="max-w-7xl mx-auto md:pt-14 pt-16 lg:pt-10 px-4 sm:px-6 lg:px-8 dark:bg-black">
          <p className="text-[20px] sm:text-[26px] md:text-[28px] text-[#6B7B94] font-normal text-center mb-6 dark:text-[#6B7B94]">
            Features
          </p>
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center px-4 sm:px-6">
              <h2 className="text-center text-[#0D1728] text-[20px] sm:text-[30px] md:text-[38px] lg:text-[48px] font-medium leading-tight max-w-2xl dark:text-white">
      ...
      <div className="absolute left-0 lg:top-[760px] md:top-[630px] top-[480px] dark:bg-black">
      ...
      <div className="h-auto pb-7 lg:pt-100 md:pt-50 pt-80 flex items-center justify-center flex-col text-center px-4  dark:bg-black">
      ...
      <div className="dark:bg-black">
        <div className="flex max-w-7xl mx-auto flex-col lg:flex-row items-center justify-center gap-12 lg:gap-12  dark:bg-black">
        ...
        <div className="flex max-w-7xl mx-auto flex-col lg:flex-row items-center justify-center gap-12 lg:gap-12 pt-10 dark:bg-black">
          <div className="lg:max-w-[460px] md:max-w-[380px] max-w-[280px]">
            <Image
            ...
            />
            <div className="flex mt-4 gap-3 dark:bg-black">
              <Image src="/Frame12(100).png" width={1000} height={1000} alt="icon" className="w-8 h-8 block dark:hidden" />
              <Image src="/Frame44(1).png" width={1000} height={1000} alt="icon" className="w-8 h-8 hidden dark:block" />
              <div>
                <h3 className="font-medium text-[20px] text-[#0D1728] dark:text-white">Smart Filters & Search</h3>
                <p className="font-normal text-[16px] text-[#6B7B94] mt-2 dark:text-[#6B7B94]">
          ...
          <div className="lg:max-w-[460px] md:max-w-[380px] max-w-[280px]">
            ...
            />
            <div className="flex mt-4 gap-3">
              <Image src="/Frame33(1).png" width={1000} height={1000} alt="icon" className="w-8 h-8 block dark:hidden" />
              <Image src="/Frame99(1).png" width={1000} height={1000} alt="icon" className="w-8 h-8 hidden dark:block" />
              <div>
                <h3 className="font-medium text-[20px] text-[#0D1728] dark:text-white">Secure Authentication</h3>
                <p className="font-normal text-[16px] text-[#6B7B94] mt-2 dark:text-[#6B7B94]">
